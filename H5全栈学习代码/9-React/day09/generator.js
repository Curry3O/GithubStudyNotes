...
let temp = test();
console.log(temp.next()); //{ value: 1, done: false }  undefined '---'
console.log(temp.next()); //{ value: 2, done: false }  undefined '+++'
...
let temp = test();
// console.log(temp.next(temp.next().value)); //1 '---'  { value: 2, done: false }
